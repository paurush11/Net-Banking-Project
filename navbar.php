...
<body>
    ...
    <div class="topnav" id="theTopNav">
        <a href="/home.php" class = "heading">HOME</a>
        <a href="/news.php" class = "heading">FINANCIAL NEWS</a>
        <a href="/contact.php" class = "heading">CONTACT US</a>
        <a href="/aboutuspage.php" class = "heading">ABOUT US</a>
