...
<body>
    <div class="flex-container ">
        <?php
            $sql0 = "SELECT id, title, created FROM grevience ORDER BY created DESC";
            ...
            while($row = $result->fetch_assoc()) {
                $id = $row["id"];
                $sql1 = "SELECT body FROM grevience_body WHERE id=$id";
                ...
                <div class="flex-item">
                    ...
                    <div class="flex-container-body">
                        <p id="grevience_body"><?php while($row1 = $result1->fetch_assoc()) {
                            echo $row1["body"]; } ?></p>
                    </div>
                </div>
